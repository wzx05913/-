...
template <> constexpr inline auto RegisterDialog::qt_create_metaobjectdata<qt_meta_tag_ZN14RegisterDialogE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "RegisterDialog",
        "on_cbxUserType_currentIndexChanged",
        "",
        "index",
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'on_cbxUserType_currentIndexChanged'
...
void RegisterDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_cbxUserType_currentIndexChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
